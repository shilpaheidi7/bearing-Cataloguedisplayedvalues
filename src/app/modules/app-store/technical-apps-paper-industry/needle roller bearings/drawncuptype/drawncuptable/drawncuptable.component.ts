...
@UntilDestroy()
@Component({
  selector: 'app-drawncuptable',
  templateUrl: './drawncuptable.component.html',
  styleUrls: ['./drawncuptable.component.scss'],
})
export class DrawncuptableComponent implements OnInit {
  ...
  // 'refer_Mass_kg',
  // 'inspection_gage',
  // 'mounting_inner_ring_pages_B466_B475'

  // 'boundary_dimensions_mm_Shaft_dia',
  // 'boundary_dimensions_mm_Fw',
  // 'boundary_dimensions_mm__D',
  // 'boundary_dimensions_mm_C_0_0_3',
  // 'boundary_dimensions_mm_C3_min',
  // 'boundary_dimensions_mm_r_min',
  // 'bearing_No',
  // 'basic_load_ratings_kN_Cr',
  ...
  columns = [
    ...
    {
      columnDef: 'Boundary_dimensions_mm_C3_min',
      header: ' C3 min',
      cell: (element: any) => `${element.Boundary_dimensions_mm_C3_min}`,
    },
    {
  ...
  GetDrawcupneedlemetricseries() {
    this.loader.open();
    this.service.GetDrawcupneedlemetricseries().subscribe((res) => {
      //  this.loader.close();
      console.log(res);
  ...
  ngOnInit() {
    this.GetDrawcupneedlemetricseries();
    //this.loader.open();
