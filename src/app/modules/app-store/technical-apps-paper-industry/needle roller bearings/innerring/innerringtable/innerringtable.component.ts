...
@UntilDestroy()
@Component({
  selector: 'app-innerringtable',
  templateUrl: './innerringtable.component.html',
  styleUrls: ['./innerringtable.component.scss'],
})
export class InnerringtableComponent implements OnInit {
  ...
  //   'inner_ring_No',
  //   'refer_Mass_kg',
  //   'shaftdia_loose_transition_fit_max',
  //   'shaftdia_loose_transition_fit_min',
  //   'shaftdia_interference_fit_max',
  //   'shaftdia_interference_fit_min',
  //   'used_with_bearing_No'
  ...
  columns = [
    ...
    {
      columnDef: 'Inner_ring_No',
      header: '',
      cell: (element: any) => `${element.Inner_ring_No}`,
    },
    { columnDef: 'Refer_Mass_kg', header: ' ', cell: (element: any) => `${element.Refer_Mass_kg}` },
    {
      columnDef: 'shaftdia_loose_transition_fit_max',
      header: 'Loose transition fit max ',
      cell: (element: any) => `${element.shaftdia_loose_transition_fit_max}`,
    },
    {
      columnDef: 'shaftdia_loose_transition_fit_min',
      header: 'Loose transition fit min',
      cell: (element: any) => `${element.shaftdia_loose_transition_fit_min}`,
    },
    {
      columnDef: 'shaftdia_interference_fit_max',
      header: 'Interference fit max',
      cell: (element: any) => `${element.shaftdia_interference_fit_max}`,
    },
    {
      columnDef: 'shaftdia_interference_fit_min',
      header: 'Interference fit min',
      cell: (element: any) => `${element.shaftdia_interference_fit_min}`,
    },

    {
      columnDef: 'Used_with_bearing_No',
      header: '',
      cell: (element: any) => `${element.Used_with_bearing_No}`,
    },
    // { columnDef: 'Refer_Mass_kg', header: '', cell: (element: any) => `${element.Refer_Mass_kg}` },
  ...
  GetHeavydutyneedleinnerrings() {
    this.loader.open();
    this.service.GetHeavydutyneedleinnerrings().subscribe((res) => {
      //  this.loader.close();
      console.log(res);
  ...
  ngOnInit() {
    this.GetHeavydutyneedleinnerrings();
    //this.loader.open();
