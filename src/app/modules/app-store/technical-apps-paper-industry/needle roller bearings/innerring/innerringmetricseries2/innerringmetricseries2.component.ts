...
@UntilDestroy()
@Component({
  selector: 'app-innerringmetricseries2',
  templateUrl: './innerringmetricseries2.component.html',
  styleUrls: ['./innerringmetricseries2.component.scss'],
})
export class Innerringmetricseries2Component implements OnInit {
  ...
  columns = [
    ...
    {
      columnDef: 'Boundary_dimensions_mm__F_1',
      header: 'F 1)',
      cell: (element: any) => `${element.Boundary_dimensions_mm__F_1}`,
    },
    {
  ...
  GetNeedlerollermetricseries2() {
    this.service.GetNeedlerollermetricseries2().subscribe((res) => {
      this.loader.close();
      console.log(res);
      //
  ...
  ngOnInit() {
    this.GetNeedlerollermetricseries2();
    //this.loader.open();
