...
@UntilDestroy()
@Component({
  selector: 'app-heavydutytable',
  templateUrl: './heavydutytable.component.html',
  styleUrls: ['./heavydutytable.component.scss'],
})
export class HeavydutytableComponent implements OnInit {
  ...
  columns = [
    ...
    // { columnDef: 'refer_Mass_kg_With_open_ends',   header:'With open ends', cell: (element: any) => `${element.refer_Mass_kg_With_open_ends}`   },
    // { columnDef: 'refer_Mass_kg_With_closed_end',   header: 'With closed end', cell: (element: any) => `${element.refer_Mass_kg_With_closed_end}`   },
  ...
  GetHeavydutyneedlemetricseries() {
    this.loader.open();
    this.service.GetHeavydutyneedlemetricseries().subscribe((res) => {
      //  this.loader.close();
      console.log(res);
  ...
  ngOnInit() {
    this.GetHeavydutyneedlemetricseries();
    //this.loader.open();
