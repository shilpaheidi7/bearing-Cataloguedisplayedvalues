...
@UntilDestroy()
@Component({
  selector: 'app-TDOtype',
  templateUrl: './TDOtype.component.html',
  styleUrls: ['./TDOtype.component.scss'],
})
export class TDOtypeComponent implements OnInit {
  ...
  GetTdotype() {
    //
    this.service.GetTdotype().subscribe((res) => {
      this.loader.close();
      console.log(res);
      //
