...
@UntilDestroy()
@Component({
  selector: 'app-Selftablesealedtype',
  templateUrl: './Selftablesealedtype.component.html',
  styleUrls: ['./Selftablesealedtype.component.scss'],
})
export class SelftablesealedtypeComponent implements OnInit {
  ...
  columns = [
    ...
    {
      columnDef: 'Limiting_speed_min_1_Grease_lub',
      header: 'Grease lub.',
      cell: (element: any) => `${element.Limiting_speed_min_1_Grease_lub}`,
    },
  ...
  //   'limiting_speed_min_1_Grease_lub',
  //   'bearing_No',
  ...
  GetSelfaligningsealedtype() {
    this.loader.open();
    this.service.GetSelfaligningsealedtype().subscribe((res) => {
      console.log(res);
  ...
  ngOnInit() {
    this.GetSelfaligningsealedtype();
    //this.loader.open();
