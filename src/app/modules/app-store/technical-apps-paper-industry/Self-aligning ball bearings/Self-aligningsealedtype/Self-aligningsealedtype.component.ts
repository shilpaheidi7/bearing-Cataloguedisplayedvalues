...
@Component({
  selector: 'app-Self-aligningsealedtype',
  templateUrl: './Self-aligningsealedtype.component.html',
  styleUrls: ['./Self-aligningsealedtype.component.scss'],
})
export class SelfAligningsealedtypeComponent implements OnInit {
  d: number;
  D: number;
  B: number;
  r: number;
