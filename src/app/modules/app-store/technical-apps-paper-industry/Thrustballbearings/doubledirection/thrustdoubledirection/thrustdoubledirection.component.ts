...
@UntilDestroy()
@Component({
  selector: 'app-thrustdoubledirection',
  templateUrl: './thrustdoubledirection.component.html',
  styleUrls: ['./thrustdoubledirection.component.scss'],
})
export class ThrustdoubledirectionComponent implements OnInit {
  ...
  columns = [
    ...
    {
      columnDef: 'Boundary_dimensions_mm__T3',
      header: 'T3  ',
      cell: (element: any) => `${element.Boundary_dimensions_mm__T3}`,
    },
    {
      columnDef: 'Boundary_dimensions_mm__T5',
      header: 'T5 ',
      cell: (element: any) => `${element.Boundary_dimensions_mm__T5}`,
    },
    {
    ...
    {
      columnDef: 'With_flat_back_faces',
      header: ' With flat back faces',
      cell: (element: any) => `${element.With_flat_back_faces}`,
    },
    {
      columnDef: 'Bearing_No_With_spherical_back_faces',
      header: 'With spherical back faces',
      cell: (element: any) => `${element.Bearing_No_With_spherical_back_faces}`,
    },
    {
      columnDef: 'Bearing_No_With_aligning_seat_races',
      header: ' With aligning seat races',
      cell: (element: any) => `${element.Bearing_No_With_aligning_seat_races}`,
    },
    { columnDef: 'dimensions_mm_d3_max', header: 'd3 max', cell: (element: any) => `${element.dimensions_mm_d3_max}` },
    {
    ...
    {
      columnDef: 'refer_Mass_kg_With_flat_back_faces ',
      header: 'With flat back faces',
      cell: (element: any) => `${element.refer_Mass_kg_With_flat_back_faces} `,
    },
    {
      columnDef: ' refer_Mass_kg_With_aligning_seat_races ',
      header: 'With aligning seat races',
      cell: (element: any) => `${element.refer_Mass_kg_With_aligning_seat_races} `,
    },
  ];
  ...
  //   'boundary_dimensions_mm__T3',
  //   'boundary_dimensions_mm__T5',
  ...
  //   'with_flat_back_faces',
  //   'bearing_No_With_spherical_back_faces',
  //   'bearing_No_With_aligning_seat_races',
  //  // "column16": 0.3,
  //   'dimensions_mm_d3_max',
  ...
  //   'refer_Mass_kg_With_flat_back_faces',
  //   'refer_Mass_kg_With_aligning_seat_races'
  ...
  // 'bearing_No_With_aligning_seat_races',
  // //"column16": 0.3,
  // 'boundary_dimensions_mm_d3_max',
  // 'boundary_dimensions_mm__D1_min',
  // 'boundary_dimensions_mm__D2',
  // 'boundary_dimensions_mm__D3',
  // 'boundary_dimensions_mm__T2',
  // 'boundary_dimensions_mm__T4',
  // 'boundary_dimensions_mm__T6',
  ...
  // 'refer_Mass_kg_With_flat_With_aligning_back_faces_seat_races',
  // //"column33": 0.118
  // ];
  ...
  GetDoubledirectionthrust() {
    this.service.GetDoubledirectionthrust().subscribe((res) => {
      this.loader.close();
      console.log(res);
      //
